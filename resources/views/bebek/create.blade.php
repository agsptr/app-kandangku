...
@section('title', 'Tambah Data Bebek')

@section('content')
    <div class="container">
        <h1 class="mb-4">Tambah Data Bebek</h1>

        <form action="{{ route('bebek.store') }}" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('jumlah_awal') is-invalid @enderror" id="jumlah_awal"
                    name="jumlah_awal" value="{{ old('jumlah_awal') }}" required>
                @error('jumlah_awal')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('asal_bibit') is-invalid @enderror" id="asal_bibit"
                    name="asal_bibit" value="{{ old('asal_bibit') }}" required>
                @error('asal_bibit')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('jenis_bebek') is-invalid @enderror" id="jenis_bebek"
                    name="jenis_bebek" value="{{ old('jenis_bebek') }}" required>
                @error('jenis_bebek')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('usia_masuk') is-invalid @enderror" id="usia_masuk"
                    name="usia_masuk" value="{{ old('usia_masuk') }}" required>
                @error('usia_masuk')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('kandang') is-invalid @enderror" id="kandang"
                    name="kandang" value="{{ old('kandang') }}" required>
                @error('kandang')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
